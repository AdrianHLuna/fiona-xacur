...
export const diseases: MedicalCondition[] = [
  {
    ...
    seo: {
      ...
      keywords: ["cirugía LASIK Mérida", "quitar lentes láser", "oftalmólogo Mérida", "miopía astigmatismo precio"]
    }
  },
  {
    ...
    seo: {
      ...
      keywords: ["vista cansada Mérida", "hipermetropía ginecólogo", "lentes progresivos Mérida", "oftalmología Mérida"]
    }
  },
  {
    id: "cond-pterigion",
    ...
    seo: {
      ...
      keywords: ["carnosidad en el ojo Mérida", "cirugía de pterigión Mérida", "ojo rojo constante Mérida", "oftalmólogo Mérida"]
    }
  },
  {
    id: "cond-cataratas",
    ...
    seo: {
      ...
      keywords: ["operación de cataratas Mérida", "lente intraocular costo Mérida", "cirujano de catarata", "oftalmólogo Mérida"]
    }
  },
  {
    id: "cond-queratocono",
    ...
    seo: {
      ...
      keywords: ["tratamiento de queratocono Mérida", "lentes esclerales Mérida", "crosslinking corneal Mérida", "oftalmólogo especialista córnea"]
    }
  },
  {
    id: "cond-ojo-seco",
    ...
    seo: {
      ...
      keywords: ["ojo seco Mérida", "ardor en los ojos Mérida", "tratamiento blefaritis", "lágrimas artificiales oftalmólogo"]
    }
  },
  {
    ...
    seo: {
      ...
      keywords: ["úlcera corneal Mérida", "dolor de ojo agudo", "infección córnea lentes de contacto", "urgencia oftalmología Mérida"]
    }
  },
  {
    id: "cond-glaucoma",
    ...
    seo: {
      ...
      keywords: ["glaucoma Mérida", "presión del ojo alta", "tonometría Mérida", "oftalmólogo Mérida"]
    }
  },
  {
    id: "cond-retinopatia",
