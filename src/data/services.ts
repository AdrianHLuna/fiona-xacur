...
export const services: MedicalService[] = [
  {
    ...
    seo: {
      ...
      keywords: ["oftalmólogo Mérida", "examen de la vista Mérida", "doctor de los ojos Mérida", "consulta de oftalmología costo"]
    }
  },
  {
    ...
    seo: {
      ...
      keywords: ["lentes esclerales Mérida", "lentes para queratocono Mérida", "adaptación lentes de contacto rígidos", "oftalmólogo Mérida"]
    }
  },
  {
    ...
    seo: {
      ...
      keywords: ["valoración LASIK Mérida", "topografía corneal Mérida", "quitar lentes láser Mérida", "paquimetría corneal Mérida"]
    }
  },
  {
    ...
    seo: {
      ...
      keywords: ["valoración catarata Mérida", "cálculo lente intraocular Mérida", "conteo celular endotelial", "cirujano de catarata Mérida"]
    }
  },
  {
    ...
    seo: {
      ...
      keywords: ["valoración queratocono Mérida", "topografía de elevación Mérida", "mapeo corneal Mérida", "oftalmólogo especialista queratocono"]
    }
  }
];
